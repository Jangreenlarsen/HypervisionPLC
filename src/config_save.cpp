/**
 * @file config_save.cpp
 * @brief Configuration persistence - save to NVS (LAYER 6)
 *
 * Saves configuration structure to non-volatile storage with CRC16 integrity
 */
...
/* ============================================================================
 * CRC16 CALCULATION (CCITT/XMODEM)
 * ============================================================================ */

/**
 * @brief CRC16-CCITT polynomial table
...
uint16_t config_calculate_crc16(const PersistConfig* cfg) {
  ...
  // CRC is at the end, so we process all bytes up to sizeof(PersistConfig) - 2
